...
if (!m) {
throw new Error(
'No pude leer la hora. Usa ejemplo: "mañana 3pm" o "2026-02-23 15:00"'
);
}
...
try {
await handleEventCommand({ bot, chatId, text });
} catch (e) {
await bot.sendMessage(
chatId,
`❌ No pude crear el evento. Detalle: ${e?.message || String(e)}`
);
}
return;
}
